...
menu.innerHTML = `
  ...
  <li><div class="dropdown">
    ...
    <div class="dropdown-content"  style="margin-right: 0px; justify-content: space-around;">
      <a href="../Fibonacci/SerieFibonacci.html" style="border-radius: 10px 10px 0 0;">Serie Fibonacci</a>
      <a style="border-radius: 0; color: #AAA;">Jueguito snake</a>
